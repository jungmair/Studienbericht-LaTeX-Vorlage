\documentclass[a4paper,12pt,parskip=full]{article}
\renewcommand{\familydefault}{\sfdefault}
\usepackage[dvipsnames]{xcolor}
\usepackage{ae}%May be useful
\usepackage[firstpage=true]{background}
\usepackage{parskip} %"german" paragraphs
\usepackage{graphicx} %needed for logo
\usepackage{framed} %needed for "Wichtige studienbezogene Änderungen"
...
\usepackage{tabularx}
\usepackage{blindtext} %only needed for testing/ demo purposes
